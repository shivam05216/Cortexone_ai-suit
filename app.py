...
# ========================== Streamlit Interface ==========================
def main():
    # Adding CSS for background and font color
    st.markdown("""
    <style>
        .reportview-container {
            background: url('https://th.bing.com/th/id/R.e983cc4515e731b8890c5e178837df96?rik=ZsHFb4nIjTmk4w&riu=http%3a%2f%2fwallpapercave.com%2fwp%2fJRSM5eu.jpg&ehk=rzkW5%2beWdyA%2fCAiShwmtmWsObZsLBT4W%2fY17QAF3azE%3d&risl=&pid=ImgRaw&r=0');
    ...
    if model_option == "Text Classification":
        st.markdown('<p class="instruction">Enter text for analysis:</p>', unsafe_allow_html=True)
    ...
    # Input for Movie Recommendation
        ...
        st.markdown('<p class="instruction">Select a User and Number of Recommendations:</p>', unsafe_allow_html=True)
    ...
    # Input for Education Recommendation
        ...
        st.markdown('<p class="instruction">Select a Category, Minimum Rating, and Number of Recommendations:</p>', unsafe_allow_html=True)
        courses = load_course_data()
        if courses.empty:
